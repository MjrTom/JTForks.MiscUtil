// <copyright file="EndianBinaryReader.cs" company="MjrTom">
...
namespace MiscUtil.IO
{
    ...
    public class EndianBinaryReader : IDisposable
    {
        ...
        public EndianBinaryReader(EndianBitConverter bitConverter, Stream stream, Encoding encoding)
        {
            ...
            ArgumentNullException.ThrowIfNull(bitConverter);
        ...
        {
            this.ReadInternal(this.buffer, 1);
            return EndianBitConverter.ToBoolean(this.buffer, 0);
        }
        ...
        public int Read()
        {
            ...
            return charsRead == 0 ? -1 : this.charBuffer[0];
        }
        ...
        public int Read(char[] data, int index, int count)
        {
            ...
            {
                throw new ArgumentException("Not enough space in buffer for specified number of characters starting at specified index", nameof(data));
            }
        ...
        private void ReadInternal(byte[] data, int size)
        {
            ...
            while (index < size)
            {
                ...
                if (read == 0)
                {
                    throw new EndOfStreamException(string.Format(CultureInfo.InvariantCulture, "End of stream reached with {0} byte{1} left to read.", size - index, (size - index) == 1 ? string.Empty : "s"));
                }
