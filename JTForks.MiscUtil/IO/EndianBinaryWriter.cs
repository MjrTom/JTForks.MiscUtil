// <copyright file="EndianBinaryWriter.cs" company="MjrTom">
...
namespace MiscUtil.IO
{
    ...
    public class EndianBinaryWriter : IDisposable
    {
        ...
        public void Write(char[] value)
        {
            ...
            this.CheckDisposed();
            var data = this.Encoding.GetBytes(value, 0, value.Length);
        ...
        {
            ObjectDisposedException.ThrowIf(this.disposed, nameof(EndianBinaryWriter));
        }
