// <copyright file="IOHelper.cs" company="MjrTom">
...
namespace MiscUtil.Compression.Vcdiff
{
    ...
    internal static class IOHelper
    {
            ...
            while (index < size)
            {
                ...
                if (read == 0)
                {
                    throw new EndOfStreamException
                        (string.Format(System.Globalization.CultureInfo.InvariantCulture, "End of stream reached with {0} byte{1} left to read.", size - index,
                        size - index == 1 ? "s" : ""));
                }
        ...
        internal static byte CheckedReadByte(Stream stream)
        {
            ...
            return b == -1 ? throw new IOException("Expected to be able to read a byte.") : (byte)b;
        }
