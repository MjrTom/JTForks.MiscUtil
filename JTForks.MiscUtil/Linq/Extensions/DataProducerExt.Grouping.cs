// <copyright file="DataProducerExt.Grouping.cs" company="MjrTom">
    ...
    public static partial class DataProducerExt
    {
            ...
            where TKey : notnull
        {
            return source.GroupBy(keySelector,
                                  static elt => elt,
                                  static (key, elements) => (IProducerGrouping<TKey, TSource>)new ProducerGrouping<TKey, TSource>(key, elements),
            ...
            where TKey : notnull
        {
            return source.GroupBy(keySelector,
                                  elementSelector,
                                  static (key, elements) => (IProducerGrouping<TKey, TElement>)new ProducerGrouping<TKey, TElement>(key, elements),
                                  EqualityComparer<TKey>.Default);
        }
