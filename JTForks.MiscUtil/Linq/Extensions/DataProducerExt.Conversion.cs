// <copyright file="DataProducerExt.Conversion.cs" company="MjrTom">
...
namespace MiscUtil.Linq.Extensions
{
    ...
    public static partial class DataProducerExt
    {
        ...
        public static ILookup<TKey, TSource> ToLookup<TSource, TKey>(
            ...
            where TKey : notnull
        {
            return ToLookup<TSource, TKey, TSource>(source, keySelector, static t => t, EqualityComparer<TKey>.Default);
        }
        ...
        public static ILookup<TKey, TSource> ToLookup<TSource, TKey>(
            ...
            where TKey : notnull
        {
            return ToLookup<TSource, TKey, TSource>(source, keySelector, static t => t, keyComparer);
        }
        ...
        public static IDictionary<TKey, TSource> ToDictionary<TSource, TKey>(
            ...
            where TKey : notnull
        {
            return ToDictionary<TSource, TKey, TSource>(source, keySelector, static t => t, EqualityComparer<TKey>.Default);
        }
        ...
        public static IDictionary<TKey, TSource> ToDictionary<TSource, TKey>(
            ...
            where TKey : notnull
        {
            return ToDictionary<TSource, TKey, TSource>(source, keySelector, static t => t, keyComparer);
        }
