// <copyright file="EndianBitConverter.cs" company="MjrTom">
...
namespace MiscUtil.Conversion
{
    ...
    public abstract class EndianBitConverter
    {
        ...
        {
            return Int64BitsToDouble(this.ToInt64(value, startIndex));
        }
        ...
        {
            return Int32BitsToSingle(this.ToInt32(value, startIndex));
        }
        ...
        private static void CheckByteArgument(byte[] value, int startIndex, int bytesRequired)
        {
            ...
            ArgumentOutOfRangeException.ThrowIfGreaterThan(startIndex, value.Length - bytesRequired);
        }
        ...
        public byte[] GetBytes(decimal value)
        {
            ...
            for (var i = 0; i < 4; i++)
            {
                this.CopyBytesCore(parts[i], 4, bytes, i * 4);
            }
        ...
        public void CopyBytes(decimal value, byte[] buffer, int index)
        {
            ...
            for (var i = 0; i < 4; i++)
            {
                this.CopyBytesCore(parts[i], 4, buffer, (i * 4) + index);
            }
        }
        ...
        {
            return this.GetBytes(DoubleToInt64Bits(value), 8);
        }
        ...
        {
            return this.GetBytes(SingleToInt32Bits(value), 4);
        }
        ...
        private void CopyBytes(long value, int bytes, byte[] buffer, int index)
        {
            ...
            this.CopyBytesCore(value, bytes, buffer, index);
        }
        ...
        /// <param name="buffer">The byte array to copy the bytes into.</param>
        /// <param name="index">The first index into the array to copy the bytes into.</param>
        protected abstract void CopyBytesCore(long value, int bytes, byte[] buffer, int index);
        ...
        {
            this.CopyBytes(DoubleToInt64Bits(value), 8, buffer, index);
        }
        ...
        {
            this.CopyBytes(SingleToInt32Bits(value), 4, buffer, index);
        }
        ...
        private readonly struct Int32SingleUnion
        {
            ...
            /// </summary>
            internal readonly int AsInt32 => this.i;

            /// <summary>
            /// Gets the value of the instance as a floating point number.
            /// </summary>
            internal readonly float AsSingle => this.f;
        }
    }
}
